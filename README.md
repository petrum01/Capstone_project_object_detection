...
-->
After 25k training steps : steady detection from close range (from further vs. previous model), but steady detection of few false positives (1 or 2 steady, a few more intermittently)
